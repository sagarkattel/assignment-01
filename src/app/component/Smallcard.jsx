...
const Smallcard = () => {
    return (
        <div className='h-[120px] w-full bg-[#ffffff] flex flex-row py-3 gap-4'>
            <div className='bg-[#ffffff] border-1 shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex-1 rounded-lg py-2 pl-4 flex flex-col cursor-pointer'>
            ...
            <div className='bg-[#ffffff] shadow-[0_3px_10px_rgb(0,0,0,0.2)] border-1 flex-1 rounded-lg py-2 pl-4 flex flex-col cursor-pointer'>
